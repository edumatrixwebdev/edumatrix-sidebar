      ...
      <footer className="footer-distributed">
        ...
        <div className="footer-center">
          ...
          <div className="phone-footer">
            ...
            <a className="phone-href" href="tel:+6281215523902">
              +62 81-215523902
            </a>
          </div>
          ...
          <div className="logo-hilpi">
            <h3>Member Of</h3>
            <img className="gambar-hilpi" src={hilpi} alt="" />
          </div>
        </div>
        <div className="footer-right">
          <h2 className="about-edu-mtx" style={{ color: "white" }}>
            Tentang Edumatrix Indonesia
          </h2>
          <br />
